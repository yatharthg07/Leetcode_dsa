<h2><a href="https://leetcode.com/problems/my-calendar-i">729. My Calendar I</a></h2><p>You are implementing a program to use as your calendar. We can add a new event if adding the event will not cause a <strong>double booking</strong>.</p>
