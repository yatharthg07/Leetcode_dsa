<h2><a href="https://leetcode.com/problems/maximum-sum-bst-in-binary-tree">1475. Maximum Sum BST in Binary Tree</a></h2><p>Given a <strong>binary tree</strong> <code>root</code>, return <em>the maximum sum of all keys of <strong>any</strong> sub-tree which is also a Binary Search Tree (BST)</em>.</p>
