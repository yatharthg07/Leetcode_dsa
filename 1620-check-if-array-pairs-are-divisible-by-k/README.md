<h2><a href="https://leetcode.com/problems/check-if-array-pairs-are-divisible-by-k">1620. Check If Array Pairs Are Divisible by k</a></h2><p>Given an array of integers <code>arr</code> of even length <code>n</code> and an integer <code>k</code>.</p>
